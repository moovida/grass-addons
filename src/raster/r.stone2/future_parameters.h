 ...
 * BOULDER_SHAPE = 2, cylinder, pseudo-dynamic modelling with ratio > 0.5 (ratio is r/h)
 * BOULDER_SHAPE = 3, disk, pseudo-dynamic modelling with ratio <= 0.5 (ratio is r/h)
 */
...
// OUT_ATTRIBUTES_2D_FILE, 2D attributes point file (e.g., attributes-2d); contain id, quota, velocita', 
//              delta dal terreno, energia (1/2*m*v*v), traiettoria, parabola
// FILE_INPUT_STAT Used to decide if Stone2 outputs binary file needed by STONESTAT 
